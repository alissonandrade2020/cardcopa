<h1 align="center">
    <img alt="CardCopa" title="#delicinha" src="card.pndg" width="200px" />
...
Você pode visualizar o layout do projeto no formato através [desse link](https://www.figma.com/file/nKwnuxfuHlaTMENELZHQKp/NLW-Copa-Card). Lembrando que você irá precisar ter uma conta no [Figma](http://figma.com/).
